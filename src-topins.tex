...
We refrain from giving a formal definition of the Fermi level here. Instead, we rely on a heuristic explanation that at absolute zero, the Fermi level is the energy threshold where all states below it are fully occupied, and all states above it are entirely unoccupied.
...
%Most of the time the approximation of crystalline solids with crystal structures exhibiting a band structure on a single particle level actually suffices for our needs.
